            ...
            <table class="table table-bordered table-hover m-l-10">
                ...
                <tfoot style="border: 0px !important;">
                    <tr align="right" style="border: 0px !important;">
                        <td colspan="8" style="border: 0px !important;"> {{$applications->appends(['hide' => request()->hide, 'entries' => request()->entries])->render()}} </td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    $('#entries').on('change', function(){
        ...
        var url = '{{route('admin.article.leaves')}}?{{request()->entries ? 'entries=:entries' : ''}}';
