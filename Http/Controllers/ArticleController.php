...
public function updateStatus(Request $request, $id)
{
    ...
    if ($article->publishing ==1 && $request->status ==2) {
        ...
        } else { return Reply::error('Please fill up all the fields!');}
...
//  * @return Response
//  */
//  public function writerActive(Writer $writer)
//  {
//     $employeeRole = $writer->role->where('role_id', 2)->first();
//     RoleUser::where('role_id', $employeeRole->role_id)->delete();
//     return Reply::success('Writer activated!');
// }
